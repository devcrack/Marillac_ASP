...
<body style="height: 637px">
    ...
    <div style="height: 497px; margin-left: 40px;" class="auto-style1">
        ...
        <asp:Button ID="Button_Profesores0" runat="server" OnClick="Button_Profesores0_Click" style="z-index: 1; left: 816px; top: 227px; position: absolute; height: 41px; width: 100px" Text="Profesores"  CssClass="buttons"/>
