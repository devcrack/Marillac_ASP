...
<body>
    ...
    <div style="height: 563px; z-index: 1; left: 10px; top: 15px; position: absolute; width: 1340px;">
        ...
        <asp:TextBox ID="TextBox_Edad" runat="server" style="z-index: 1; left: 195px; top: 460px; position: absolute; margin-top: 0px; width: 56px;" Enabled="False"></asp:TextBox>    
        ...
        <asp:CheckBox ID="CheckBox_Lunes" runat="server" style="z-index: 1; left: 400px; top: 420px; position: absolute" Text="Lunes" OnCheckedChanged="CheckBox_Lunes_CheckedChanged" AutoPostBack="True" />
        <asp:CheckBox ID="CheckBox_Martes" runat="server" style="z-index: 1; left: 490px; top: 420px; position: absolute; " Text="Martes" OnCheckedChanged="CheckBox_Martes_CheckedChanged" AutoPostBack="True" />
        <asp:CheckBox ID="CheckBox_Miercoles" runat="server" style="z-index: 1; left: 580px; top: 420px; position: absolute" Text="Miercoles" OnCheckedChanged="CheckBox_Miercoles_CheckedChanged" AutoPostBack="True" />
        <asp:CheckBox ID="CheckBox_Jueves" runat="server" style="z-index: 1; left: 670px; top: 420px; position: absolute" Text="Jueves" OnCheckedChanged="CheckBox_Jueves_CheckedChanged" AutoPostBack="True" />
        <asp:CheckBox ID="CheckBox_Viernes" runat="server" style="z-index: 1; left: 400px; top: 460px; position: absolute; " Text="Viernes" OnCheckedChanged="CheckBox_Viernes_CheckedChanged" AutoPostBack="True" />
        <asp:CheckBox ID="CheckBox_Sabado" runat="server" style="z-index: 1; left: 490px; top: 460px; position: absolute" Text="Sabado" OnCheckedChanged="CheckBox_Sabado_CheckedChanged" AutoPostBack="True" />
        <asp:CheckBox ID="CheckBox_Domingo" runat="server" style="z-index: 1; left: 580px; top: 460px; position: absolute" Text="Domingo" OnCheckedChanged="CheckBox_Domingo_CheckedChanged" AutoPostBack="True" />
        ...
        <asp:RadioButton ID="radioButt_Male" runat="server" style="z-index: 1; left: 150px; top: 339px; position: absolute" Text="Masculino" AutoPostBack="True" OnCheckedChanged="radioButt_Male_CheckedChanged1" />
        <asp:RadioButton ID="radioButt_Female" runat="server" style="z-index: 1; left: 250px; top: 339px; position: absolute" Text="Femenino" AutoPostBack="True" OnCheckedChanged="radioButt_Female_CheckedChanged1" />
    </div>
    </form>
</body>
</html>
