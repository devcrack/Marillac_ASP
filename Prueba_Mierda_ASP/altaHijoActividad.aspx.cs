...
{
    public partial class altaHijoActividad : System.Web.UI.Page
    {

        string stringConnection = "Data Source = localhost; User Id = MARILLAC_DEF; Password = oracle";
        int id;
        int altaB;
        ...
        void altaHijo()
        {
            try
            {
                ...
                cmd = "INSERT INTO INSCRIPCIONHIJO (IDACTIVIDAD, IDHIJO) VALUES (" + Convert.ToInt16(Label2.Text) + " , " + Convert.ToInt16(Label1.Text) + ")";
        ...
        void mostrarDatos()
        {
            try
            {
                ...
                m.Open();
                string consulta = "SELECT IDHIJO, NOMBRE, PATERNO, MATERNO FROM HIJO";
